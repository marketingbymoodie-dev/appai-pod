...
export const AOP_TEMPLATE_IDS = ["leggings_v1", "hoodie_v1", "generic_aop_v1", "tote_folded_v1"] as const;
...
export const AOP_TEMPLATE_ADMIN_OPTIONS: { value: string; label: string }[] = [
  ...
  { value: "tote_folded_v1", label: "Folded tote (duplicate + 180° bottom panel)" },
];
