            ...
            <div className="space-y-4 mt-4">
              ...
              {(isStorefront || isShopify) && productTypeConfig?.description && (
                <div className="hidden md:block space-y-1.5">
                  ...
                  <div
                    className="rounded-md border border-gray-300 bg-background px-3 py-2 text-sm text-muted-foreground leading-relaxed prose prose-sm max-w-none overflow-y-auto"
