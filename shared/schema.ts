...
export const STYLE_PRESETS = [
  ...
  // IMPORTANT: Background must be PURE WHITE (#FFFFFF). Any white elements in the design must use #FCFCFC (252,252,252) or darker
  { id: "centered-graphic", name: "Centered Graphic", promptPrefix: "Create an ISOLATED graphic design on a PURE WHITE (#FFFFFF) background. CRITICAL: The background must be exactly pure white RGB(255,255,255). Any white or light elements in the design itself must use #FCFCFC (RGB 252,252,252) or darker - never pure white. The design must be a single centered element with NO scenic background, NO landscapes, NO environments. Just the main subject isolated and centered, suitable for t-shirt printing. Create a clean isolated design of", category: "apparel" },
  { id: "vintage-logo", name: "Vintage Logo", promptPrefix: "Create an ISOLATED vintage-style logo or emblem on a PURE WHITE (#FFFFFF) background. CRITICAL: The background must be exactly pure white RGB(255,255,255). Any white or light elements in the design itself must use #FCFCFC (RGB 252,252,252) or darker - never pure white. The design must be a single centered badge/emblem with NO scenic background behind it. Just the logo itself, distressed and retro-looking, suitable for t-shirt printing. Create an isolated vintage badge of", category: "apparel" },
  { id: "minimalist-icon", name: "Minimalist Icon", promptPrefix: "Create an ISOLATED minimalist icon on a PURE WHITE (#FFFFFF) background. CRITICAL: The background must be exactly pure white RGB(255,255,255). Any white or light elements in the design itself must use #FCFCFC (RGB 252,252,252) or darker - never pure white. The design must be a simple, clean symbol with NO scenic background, NO environments. Just the icon itself centered with clean lines, suitable for t-shirt printing. Create a simple isolated icon of", category: "apparel" },
  { id: "typography", name: "Typographic Design", promptPrefix: "Create ISOLATED typography on a PURE WHITE (#FFFFFF) background. CRITICAL: The background must be exactly pure white RGB(255,255,255). Any white or light elements in the lettering must use #FCFCFC (RGB 252,252,252) or darker - never pure white. The design must be stylized text/lettering only with NO scenic background, NO landscapes behind it. Just the text itself, bold and eye-catching, suitable for t-shirt printing. Create isolated typography of", category: "apparel" },
  { id: "illustration-motif", name: "Illustrated Motif", promptPrefix: "Create an ISOLATED hand-drawn illustration on a PURE WHITE (#FFFFFF) background. CRITICAL: The background must be exactly pure white RGB(255,255,255). Any white or light elements in the design itself must use #FCFCFC (RGB 252,252,252) or darker - never pure white. The design must be a single centered character or motif with NO scenic background, NO landscapes, NO environments behind it. Just the illustration itself with clean edges, suitable for t-shirt printing. Create an isolated illustrated motif of", category: "apparel" },
  { id: "retro-badge", name: "Retro Badge", promptPrefix: "Create an ISOLATED retro-style badge on a PURE WHITE (#FFFFFF) background. CRITICAL: The background must be exactly pure white RGB(255,255,255). Any white or light elements in the design itself must use #FCFCFC (RGB 252,252,252) or darker - never pure white. The design must be a single circular or shield-shaped emblem with NO scenic background behind it. Just the badge itself with vintage textures, suitable for t-shirt chest placement. Create an isolated retro badge of", category: "apparel" },
] as const;
